...
parser.add_argument(
        "--save_dir",
        type=str,
        default='/userHome/userhome1/sojeong/2401/0222_metric_3/coco/1_h/0.2',
...
parser.add_argument(
        ...
        default="/userHome/userhome1/sojeong/2401/data/wikiart/1_nh",
        help="path to style image_dir"
    )
parser.add_argument(
        "--gen_dir",
        type=str,
        default='/userHome/userhome1/sojeong/2401/0222_data/3_vct/1_h/0.2',
